...
const Home = () => {
  return (
    <div className="bg-gradient-to-br from-slate-50 via-gray-50 to-stone-100 min-h-screen">
      ...
      {/* Pop Culture Section - Removed rating elements */}
      <section className="py-16 px-4 bg-gradient-to-b from-white to-slate-50">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-black text-indigo-600 mb-6">Pop Culture Essentials</h2>
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">T-shirts, posters, merch – for fans, by fans. Dive into designs that celebrate what you love.</p>
        </div>
      </section>
      ...
      {/* Artist Spotlight - Removed specific artist details, kept products */}
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-indigo-600 mb-4">Artist Spotlight</h2>
            <p className="text-xl text-slate-600">Fresh designs from rising creators.</p>
          </div>
